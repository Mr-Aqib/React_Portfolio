      ...
      <div className="container-fluid m-0 p-0  ">
        ...
        <div className="d-flex flex-column align-items-center gap-4 ">
          ...
          <div className="d-flex eduglasscard col-12 col-lg-6 align-items-center gap-2 flex-column  mt-4">
            <h2 className="m-0 p-0 ">MERN Stack</h2>
            <p
              style={{
                color: "#a6b28b",
              }}
        ...
        <div className="d-flex flex-column align-items-center gap-4 ">
          {/* Card 3 */}
          <div className="d-flex eduglasscard col-12 col-lg-6 align-items-center gap-2 flex-column  mt-4">
            <h2 className="m-0 p-0 ">Spoken English Proficiency </h2>
            <p
              style={{
                color: "#a6b28b",
              }}
            ...
            <div className="d-flex flex-row align-items-center gap-2">
              ...
              >
                <RiEnglishInput size={25} color="#F7DF1D" />
              </motion.div>
            </div>
            <p
              style={{
